...
'''OpenGL extension WL.create_wayland_buffer_from_image

This module customises the behaviour of the
OpenGL.raw.EGL.WL.create_wayland_buffer_from_image to provide a more
Python-friendly API
...
_EXTENSION_NAME = _define(globals(), 'OpenGL.raw.EGL.WL.create_wayland_buffer_from_image')

def eglInitCreateWaylandBufferFromImageWL():
