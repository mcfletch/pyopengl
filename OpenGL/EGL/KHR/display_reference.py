...
'''OpenGL extension KHR.display_reference

This module customises the behaviour of the
OpenGL.raw.EGL.KHR.display_reference to provide a more
Python-friendly API
...
_EXTENSION_NAME = _define(globals(), 'OpenGL.raw.EGL.KHR.display_reference')

def eglInitDisplayReferenceKHR():
