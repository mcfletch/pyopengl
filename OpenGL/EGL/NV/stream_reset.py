...
'''OpenGL extension NV.stream_reset

This module customises the behaviour of the
OpenGL.raw.EGL.NV.stream_reset to provide a more
Python-friendly API
...
_EXTENSION_NAME = _define(globals(), 'OpenGL.raw.EGL.NV.stream_reset')

def eglInitStreamResetNV():
