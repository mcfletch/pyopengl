...
'''OpenGL extension ANDROID.presentation_time

This module customises the behaviour of the
OpenGL.raw.EGL.ANDROID.presentation_time to provide a more
Python-friendly API
...
_EXTENSION_NAME = _define(globals(), 'OpenGL.raw.EGL.ANDROID.presentation_time')

def eglInitPresentationTimeANDROID():
