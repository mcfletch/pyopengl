...
# COMPSIZE(target,format,type) glGetHistogramEXT=wrapper.wrapper(glGetHistogramEXT)
...
# COMPSIZE(target,format,type) glGetMinmaxEXT=wrapper.wrapper(glGetMinmaxEXT)
