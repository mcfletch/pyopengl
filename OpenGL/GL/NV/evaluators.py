...
# COMPSIZE(target,pname) glGetMapParameterivNV=wrapper.wrapper(glGetMapParameterivNV)
# COMPSIZE(target,pname) glGetMapParameterfvNV=wrapper.wrapper(glGetMapParameterfvNV)
