...
# COMPSIZE(target,format,type) glGetColorTable=wrapper.wrapper(glGetColorTable)
...
# COMPSIZE(target,format,type) glGetConvolutionFilter=wrapper.wrapper(glGetConvolutionFilter)
...
# OUTPUT MULTIPLE glGetSeparableFilter
# OUTPUT MULTIPLE glGetSeparableFilter
# OUTPUT MULTIPLE glGetSeparableFilter
# COMPSIZE(target,format,type) glGetHistogram=wrapper.wrapper(glGetHistogram)
...
# COMPSIZE(target,format,type) glGetMinmax=wrapper.wrapper(glGetMinmax)
