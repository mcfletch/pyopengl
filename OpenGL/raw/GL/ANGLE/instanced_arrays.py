...
import ctypes
_EXTENSION_NAME = 'GL_ANGLE_instanced_arrays'
def _f( function ):
    return _p.createFunction( function,_p.PLATFORM.GL,'GL_ANGLE_instanced_arrays',error_checker=_errors._error_checker)
