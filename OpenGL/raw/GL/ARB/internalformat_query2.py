...
import ctypes
EXTENSION_NAME = 'GL_ARB_internalformat_query2'
def _f( function ):
    return _p.createFunction( function,_p.GL,'GL_ARB_internalformat_query2',False)
_p.unpack_constants( """GL_INTERNALFORMAT_SUPPORTED 0x826F
