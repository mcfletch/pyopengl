...
import ctypes
_EXTENSION_NAME = 'GL_OES_vertex_array_object'
def _f( function ):
    return _p.createFunction( function,_p.PLATFORM.GL,'GL_OES_vertex_array_object',error_checker=_errors._error_checker)
