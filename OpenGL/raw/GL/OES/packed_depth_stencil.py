...
import ctypes
_EXTENSION_NAME = 'GL_OES_packed_depth_stencil'
def _f( function ):
    return _p.createFunction( function,_p.PLATFORM.GL,'GL_OES_packed_depth_stencil',error_checker=_errors._error_checker)
