...
def _f( function ):
    return _p.createFunction( function,_p.GL,'GL_EXT_framebuffer_object',False)
_p.unpack_constants( """GL_INVALID_FRAMEBUFFER_OPERATION_EXT 0x506
...
GL_RENDERBUFFER_STENCIL_SIZE_EXT 0x8D55""", globals())
