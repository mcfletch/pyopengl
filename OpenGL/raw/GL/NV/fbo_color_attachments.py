...
import ctypes
_EXTENSION_NAME = 'GL_NV_fbo_color_attachments'
def _f( function ):
    return _p.createFunction( function,_p.PLATFORM.GL,'GL_NV_fbo_color_attachments',error_checker=_errors._error_checker)
