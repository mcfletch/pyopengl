...
"""
    ...
    def importAble(cls, name, value):
        ...
        return (
            ...
            or isinstance(value, constant.Constant)
            or value.__class__.__name__.endswith(
                'CFunctionType'
    ...
    def filter_items(self, items, expressions=None, symbols=None, types=None):
        ...
        return self._super.filter_items(
            self, items, expressions=expressions, symbols=symbols, types=types
        )
    ...
    def cmpitems(self, a, b):
        ...
        try:
            return cmp(
                (a.name, getattr(a, "location", -1), a.__class__),
                (b.name, getattr(b, "location", 1), b.__class__),
            )
...
"""
    ...
    CTYPE_TO_ARRAY_TYPE = {
        ...
        'uint': 'GLuintArray',
        'GLintptr': 'GLintptrArray',
        'GLintptrARB': 'GLintptrArray',
        'GLvdpauSurfaceNV': 'GLintptrArray',
        'GLsizeiptr': 'GLsizeiptrArray',
        'GLsizeiptrARB': 'GLsizeiptrArray',
